...
T3-SEMANTIC MILESTONE LOCKED 2026-06-15 (originally via PR #201, which targeted the stale `master` branch; ported to `main` 2026-07-01 with proof artifacts regenerated and coqchk re-run on `main`'s tree).
