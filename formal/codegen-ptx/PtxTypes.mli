...
val ptx_expr_ast_rect :
  ...
  (Float64.t -> 'a1) ->
  (string -> 'a1) ->
  (ptx_binop_tag -> ptx_expr_ast -> 'a1 -> ptx_expr_ast -> 'a1 -> 'a1) ->
  (ptx_cmp_tag -> ptx_expr_ast -> 'a1 -> ptx_expr_ast -> 'a1 -> 'a1) ->
  (ptx_expr_ast -> 'a1 -> 'a1) ->
  (ptx_expr_ast -> 'a1 -> 'a1) ->
  'a1 ->
  'a1 ->
  'a1 ->
  (ptx_intrinsic_tag -> ptx_expr_ast -> 'a1 -> 'a1) ->
...
val agpu_eval_ptx_binop : ptx_binop_tag -> ptx_val -> ptx_val -> ptx_val option
...
val agpu_eval_ptx : agpu_state -> ptx_expr_ast -> (ptx_val * agpu_state) option
