...
let reg_write name v st =
  {
    regs = (fun n -> if eqb n name then Some v else st.regs n);
    tc = st.tc;
    mem = st.mem;
  }
...
(** val ir_stmt_rect : 'a1 -> (ir_stmt -> 'a1 -> ir_stmt -> 'a1 -> 'a1) ->
    (string -> ir_expr -> ir_stmt -> 'a1 -> 'a1) -> (string -> ir_expr ->
    ir_stmt -> 'a1 -> 'a1) -> (string -> ir_expr -> 'a1) -> (ir_expr -> ir_stmt
    -> 'a1 -> ir_stmt -> 'a1 -> 'a1) -> 'a1 -> ir_stmt -> 'a1 **)
...
let rec ir_stmt_rect f f0 f1 f2 f3 f4 f5 = function
  ...
  | ISSeq (i0, i1) ->
      f0
        i0
        (ir_stmt_rect f f0 f1 f2 f3 f4 f5 i0)
        i1
...
(** val ir_stmt_rec : 'a1 -> (ir_stmt -> 'a1 -> ir_stmt -> 'a1 -> 'a1) ->
    (string -> ir_expr -> ir_stmt -> 'a1 -> 'a1) -> (string -> ir_expr ->
    ir_stmt -> 'a1 -> 'a1) -> (string -> ir_expr -> 'a1) -> (ir_expr -> ir_stmt
    -> 'a1 -> ir_stmt -> 'a1 -> 'a1) -> 'a1 -> ir_stmt -> 'a1 **)
...
let rec ir_stmt_rec f f0 f1 f2 f3 f4 f5 = function
  ...
  | ISSeq (i0, i1) ->
      f0
        i0
        (ir_stmt_rec f f0 f1 f2 f3 f4 f5 i0)
        i1
...
let rec agpu_exec_ir st = function
  ...
  | ISLet (name, e, body) -> (
      ...
      | Some p ->
          let v, st1 = p in
          agpu_exec_ir (reg_write name v st1) body
      | None -> None)
...
(** val ptx_stmt_ast_rect : 'a1 -> (ptx_stmt_ast -> 'a1 -> ptx_stmt_ast -> 'a1
    -> 'a1) -> (string -> ptx_expr_ast -> ptx_stmt_ast -> 'a1 -> 'a1) -> (string
    -> ptx_expr_ast -> ptx_stmt_ast -> 'a1 -> 'a1) -> (string -> ptx_expr_ast ->
    'a1) -> (ptx_expr_ast -> ptx_stmt_ast -> 'a1 -> ptx_stmt_ast -> 'a1 -> 'a1)
    -> 'a1 -> ptx_stmt_ast -> 'a1 **)
...
let rec ptx_stmt_ast_rect f f0 f1 f2 f3 f4 f5 = function
  ...
  | PSSeq (p0, p1) ->
      f0
        p0
        (ptx_stmt_ast_rect f f0 f1 f2 f3 f4 f5 p0)
        p1
...
(** val ptx_stmt_ast_rec : 'a1 -> (ptx_stmt_ast -> 'a1 -> ptx_stmt_ast -> 'a1 ->
    'a1) -> (string -> ptx_expr_ast -> ptx_stmt_ast -> 'a1 -> 'a1) -> (string ->
    ptx_expr_ast -> ptx_stmt_ast -> 'a1 -> 'a1) -> (string -> ptx_expr_ast ->
    'a1) -> (ptx_expr_ast -> ptx_stmt_ast -> 'a1 -> ptx_stmt_ast -> 'a1 -> 'a1)
    -> 'a1 -> ptx_stmt_ast -> 'a1 **)
...
let rec ptx_stmt_ast_rec f f0 f1 f2 f3 f4 f5 = function
  ...
  | PSSeq (p0, p1) ->
      f0
        p0
        (ptx_stmt_ast_rec f f0 f1 f2 f3 f4 f5 p0)
        p1
...
let rec agpu_exec_ptx_stmt st = function
  ...
  | PSLet (name, e, body) -> (
      ...
      | Some p ->
          let v, st1 = p in
          agpu_exec_ptx_stmt (reg_write name v st1) body
      | None -> None)
