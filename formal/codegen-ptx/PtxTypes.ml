...
type ptx_type = PTX_U32 | PTX_U64 | PTX_F32 | PTX_F64 | PTX_Pred
...
(** val elttype_rect : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> (elttype -> 'a1
    -> 'a1) -> (elttype -> 'a1 -> 'a1) -> elttype -> 'a1 **)
...
(** val elttype_rec : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> (elttype -> 'a1
    -> 'a1) -> (elttype -> 'a1 -> 'a1) -> elttype -> 'a1 **)
...
(** val ptx_binop_tag_rect : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 ->
    'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> ptx_binop_tag -> 'a1 **)
...
(** val ptx_binop_tag_rec : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1
    -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> ptx_binop_tag -> 'a1 **)
...
(** val ptx_cmp_tag_rect : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> ptx_cmp_tag
    -> 'a1 **)
...
(** val ptx_cmp_tag_rec : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> ptx_cmp_tag
    -> 'a1 **)
...
(** val ptx_intrinsic_tag_rect : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1
    -> 'a1 -> 'a1 -> ptx_intrinsic_tag -> 'a1 **)
...
(** val ptx_intrinsic_tag_rec : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 ->
    'a1 -> 'a1 -> ptx_intrinsic_tag -> 'a1 **)
...
(** val ptx_expr_ast_rect : (int -> 'a1) -> (int -> 'a1) -> (Float64.t -> 'a1)
    -> (Float64.t -> 'a1) -> (string -> 'a1) -> (ptx_binop_tag -> ptx_expr_ast
    -> 'a1 -> ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_cmp_tag -> ptx_expr_ast -> 'a1
    -> ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_expr_ast -> 'a1 -> 'a1) ->
    (ptx_expr_ast -> 'a1 -> 'a1) -> 'a1 -> 'a1 -> 'a1 -> (ptx_intrinsic_tag ->
    ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_expr_ast -> 'a1 -> ptx_expr_ast -> 'a1
    -> ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_expr_ast -> 'a1 -> ptx_expr_ast ->
    'a1 -> ptx_expr_ast -> 'a1 -> 'a1) -> ptx_expr_ast -> 'a1 **)

let rec ptx_expr_ast_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 =
  function
  | PtxLitU32 n -> f n
  | PtxLitU64 n -> f0 n
  ...
  | PtxGlobalRead p0 ->
      f6
        p0
        (ptx_expr_ast_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 p0)
  | PtxSharedRead p0 ->
      f7
        p0
        (ptx_expr_ast_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 p0)
...
(** val ptx_expr_ast_rec : (int -> 'a1) -> (int -> 'a1) -> (Float64.t -> 'a1) ->
    (Float64.t -> 'a1) -> (string -> 'a1) -> (ptx_binop_tag -> ptx_expr_ast ->
    'a1 -> ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_cmp_tag -> ptx_expr_ast -> 'a1 ->
    ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_expr_ast -> 'a1 -> 'a1) -> (ptx_expr_ast
    -> 'a1 -> 'a1) -> 'a1 -> 'a1 -> 'a1 -> (ptx_intrinsic_tag -> ptx_expr_ast ->
    'a1 -> 'a1) -> (ptx_expr_ast -> 'a1 -> ptx_expr_ast -> 'a1 -> ptx_expr_ast
    -> 'a1 -> 'a1) -> (ptx_expr_ast -> 'a1 -> ptx_expr_ast -> 'a1 ->
    ptx_expr_ast -> 'a1 -> 'a1) -> ptx_expr_ast -> 'a1 **)

let rec ptx_expr_ast_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 =
  function
  | PtxLitU32 n -> f n
  | PtxLitU64 n -> f0 n
  | PtxLitF32 f14 -> f1 f14
  ...
  | PtxGlobalRead p0 ->
      f6
        p0
        (ptx_expr_ast_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 p0)
  | PtxSharedRead p0 ->
      f7
        p0
        (ptx_expr_ast_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 p0)
...
(** val agpu_eval_ptx_binop : ptx_binop_tag -> ptx_val -> ptx_val -> ptx_val
    option **)
...
let agpu_eval_ptx_binop op v1 v2 =
  ...
  | PAdd -> (
      match v1 with
      | U32 a -> (
          match v2 with U32 b -> Some (U32 (Nat.add a b)) | _ -> None)
      | U64 a -> (
          match v2 with U64 b -> Some (U64 (Nat.add a b)) | _ -> None)
      | F32 a -> ( match v2 with F32 b -> Some (F32 (add a b)) | _ -> None)
      | F64 a -> ( match v2 with F64 b -> Some (F64 (add a b)) | _ -> None)
      | Pred _ -> None)
  | PSub -> (
      match v1 with
      | U32 a -> (
          match v2 with U32 b -> Some (U32 (Nat.sub a b)) | _ -> None)
      | U64 a -> (
          match v2 with U64 b -> Some (U64 (Nat.sub a b)) | _ -> None)
      | F32 a -> ( match v2 with F32 b -> Some (F32 (sub a b)) | _ -> None)
      | F64 a -> ( match v2 with F64 b -> Some (F64 (sub a b)) | _ -> None)
      | Pred _ -> None)
  | PMul -> (
      match v1 with
      | U32 a -> (
          match v2 with U32 b -> Some (U32 (Nat.mul a b)) | _ -> None)
      | U64 a -> (
          match v2 with U64 b -> Some (U64 (Nat.mul a b)) | _ -> None)
      | F32 a -> ( match v2 with F32 b -> Some (F32 (mul a b)) | _ -> None)
      | F64 a -> ( match v2 with F64 b -> Some (F64 (mul a b)) | _ -> None)
      | Pred _ -> None)
  | PDiv -> (
      match v1 with
      | U32 a -> (
          match v2 with U32 b -> Some (U32 (PeanoNat.Nat.div a b)) | _ -> None)
      | U64 a -> (
          match v2 with U64 b -> Some (U64 (PeanoNat.Nat.div a b)) | _ -> None)
      | F32 a -> ( match v2 with F32 b -> Some (F32 (div a b)) | _ -> None)
      | F64 a -> ( match v2 with F64 b -> Some (F64 (div a b)) | _ -> None)
      | Pred _ -> None)
  | PMod -> (
      match v1 with
      | U32 a -> (
...
let agpu_eval_ptx_cmp op v1 v2 =
  ...
  | PEq -> (
      match v1 with
      | U32 a -> (
          match v2 with U32 b -> Some (nat_cmp_to_u32 (a = b)) | _ -> None)
      | U64 a -> (
          match v2 with U64 b -> Some (nat_cmp_to_u32 (a = b)) | _ -> None)
      | F32 a -> (
          match v2 with
  ...
  | PGe -> (
      match v1 with
      | U32 a -> (
          match v2 with U32 b -> Some (nat_cmp_to_u32 (b <= a)) | _ -> None)
      | U64 a -> (
          match v2 with U64 b -> Some (nat_cmp_to_u32 (b <= a)) | _ -> None)
      | F32 a -> (
          match v2 with
...
let agpu_eval_ptx_intrinsic tag v =
  match tag with
  | PISin32 -> ( match v with F32 x -> Some (F32 (sin_f32 x)) | _ -> None)
  | PICos32 -> ( match v with F32 x -> Some (F32 (cos_f32 x)) | _ -> None)
  | PISqrt32 -> ( match v with F32 x -> Some (F32 (sqrt x)) | _ -> None)
  | PIFabs32 -> ( match v with F32 x -> Some (F32 (abs x)) | _ -> None)
  | PISin64 -> ( match v with F64 x -> Some (F64 (sin_f64 x)) | _ -> None)
  | PICos64 -> ( match v with F64 x -> Some (F64 (cos_f64 x)) | _ -> None)
  | PISqrt64 -> ( match v with F64 x -> Some (F64 (sqrt x)) | _ -> None)
  | PIFabs64 -> ( match v with F64 x -> Some (F64 (abs x)) | _ -> None)
  | PIFma -> None

(** val agpu_eval_ptx : agpu_state -> ptx_expr_ast -> (ptx_val * agpu_state)
    option **)
