...
(** val ptx_val_rect : (int -> 'a1) -> (int -> 'a1) -> (Float64.t -> 'a1) ->
    (Float64.t -> 'a1) -> (bool -> 'a1) -> ptx_val -> 'a1 **)
...
(** val ptx_val_rec : (int -> 'a1) -> (int -> 'a1) -> (Float64.t -> 'a1) ->
    (Float64.t -> 'a1) -> (bool -> 'a1) -> ptx_val -> 'a1 **)
...
let mem_space_rect f f0 = function Global -> f | Shared -> f0

(** val mem_space_rec : 'a1 -> 'a1 -> mem_space -> 'a1 **)

let mem_space_rec f f0 = function Global -> f | Shared -> f0
...
let global_mem a = a.global_mem

(** val shared_mem : agpu_mem -> int -> ptx_val **)

let shared_mem a = a.shared_mem
...
(** val ir_const_rect : (int -> 'a1) -> (int -> 'a1) -> (Float64.t -> 'a1) ->
    (Float64.t -> 'a1) -> (bool -> 'a1) -> 'a1 -> ir_const -> 'a1 **)
...
(** val ir_const_rec : (int -> 'a1) -> (int -> 'a1) -> (Float64.t -> 'a1) ->
    (Float64.t -> 'a1) -> (bool -> 'a1) -> 'a1 -> ir_const -> 'a1 **)
...
(** val ir_binop_rect : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 ->
    'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 ->
    ir_binop -> 'a1 **)

let ir_binop_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 =
  function
  | Add -> f
  | Sub -> f0
  | Mul -> f1
...
(** val ir_binop_rec : 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 ->
    'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 ->
    ir_binop -> 'a1 **)

let ir_binop_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16 =
  function
  | Add -> f
  | Sub -> f0
  | Mul -> f1
...
type ir_elttype = TInt32 | TInt64 | TFloat32 | TFloat64 | TBool
...
let ir_memspace_rect f f0 = function MS_Global -> f | MS_Shared -> f0

(** val ir_memspace_rec : 'a1 -> 'a1 -> ir_memspace -> 'a1 **)

let ir_memspace_rec f f0 = function MS_Global -> f | MS_Shared -> f0
...
(** val ir_expr_rect : (ir_const -> 'a1) -> (string -> 'a1) -> (ir_binop ->
    ir_expr -> 'a1 -> ir_expr -> 'a1 -> 'a1) -> (ir_memspace -> ir_expr -> 'a1
    -> ir_expr -> 'a1 -> 'a1) -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> (ir_expr ->
    'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) ->
    (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 -> ir_expr -> 'a1 -> ir_expr ->
    'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) ->
    (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 ->
    ir_expr -> 'a1 -> ir_expr -> 'a1 -> 'a1) -> ir_expr -> 'a1 **)

let rec ir_expr_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
    f17 = function
  | IEConst i0 -> f i0
  | IEVar s -> f0 s
  | IEBinop (i0, i1, i2) ->
...
(** val ir_expr_rec : (ir_const -> 'a1) -> (string -> 'a1) -> (ir_binop ->
    ir_expr -> 'a1 -> ir_expr -> 'a1 -> 'a1) -> (ir_memspace -> ir_expr -> 'a1
    -> ir_expr -> 'a1 -> 'a1) -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> 'a1 -> (ir_expr ->
    'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 -> 'a1) ->
    (ir_expr -> 'a1 -> 'a1) -> (ir_expr -> 'a1 -> ir_expr -> 'a1 -> ir_expr ->
...
let rec ir_expr_rec f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
    f17 = function
  | IEConst i0 -> f i0
  | IEVar s -> f0 s
  | IEBinop (i0, i1, i2) ->
...
let bool_to_nat = function true -> Stdlib.Int.succ 0 | false -> 0

(** val nat_cmp_to_u32 : bool -> ptx_val **)

let nat_cmp_to_u32 b = U32 (bool_to_nat b)
...
let rec agpu_eval_ir st = function
  ...
  | IESin32 e1 -> (
      ...
      | Some p -> (
          let p0, st1 = p in
          match p0 with F32 x -> Some (F32 (sin_f32 x), st1) | _ -> None)
      | None -> None)
  | IECos32 e1 -> (
      match agpu_eval_ir st e1 with
      | Some p -> (
          let p0, st1 = p in
          match p0 with F32 x -> Some (F32 (cos_f32 x), st1) | _ -> None)
      | None -> None)
  | IESqrt32 e1 -> (
      match agpu_eval_ir st e1 with
      | Some p -> (
          let p0, st1 = p in
          match p0 with F32 x -> Some (F32 (sqrt x), st1) | _ -> None)
      | None -> None)
  | IEFabs32 e1 -> (
      match agpu_eval_ir st e1 with
      | Some p -> (
          let p0, st1 = p in
          match p0 with F32 x -> Some (F32 (abs x), st1) | _ -> None)
      | None -> None)
  | IEFma32 (ea, eb, ec) -> (
  ...
  | IESin64 e1 -> (
      ...
      | Some p -> (
          let p0, st1 = p in
          match p0 with F64 x -> Some (F64 (sin_f64 x), st1) | _ -> None)
      | None -> None)
  | IECos64 e1 -> (
      match agpu_eval_ir st e1 with
      | Some p -> (
          let p0, st1 = p in
          match p0 with F64 x -> Some (F64 (cos_f64 x), st1) | _ -> None)
      | None -> None)
  | IESqrt64 e1 -> (
      match agpu_eval_ir st e1 with
      | Some p -> (
          let p0, st1 = p in
          match p0 with F64 x -> Some (F64 (sqrt x), st1) | _ -> None)
      | None -> None)
  | IEFabs64 e1 -> (
      match agpu_eval_ir st e1 with
      | Some p -> (
          let p0, st1 = p in
          match p0 with F64 x -> Some (F64 (abs x), st1) | _ -> None)
      | None -> None)
  | IEFma64 (ea, eb, ec) -> (
      match agpu_eval_ir st ea with
      | Some p -> (
